...
templates.roadworthyPrediction = function (
  sellerName,
  vehicleModel,
  predictionResult
) {
									...
									<tbody>
										<tr>
											<td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;padding:35px">
												...
												<p style="margin-top:0;color:#74787e;font-size:16px;line-height:1.5em">
													We have processed the roadworthy prediction for your vehicle.
												</p>
												<p style="margin-top:0;color:#74787e;font-size:16px;line-height:1.5em">
													<strong>Vehicle Model:</strong> ${vehicleModel}<br />
													<strong>Prediction Status:</strong> ${predictionResult}<br />
												</p>
												<p style="margin-top:0;color:#74787e;font-size:16px;line-height:1.5em">
													Please note that this prediction is based on the available data and analysis. It is not 100% accurate and should not be taken as a guarantee of the vehicle's roadworthiness. For an official certification, please visit an authorized inspection center.
												</p>
												<br />
												<p style="margin-top:10px;color:#74787e;font-size:16px;line-height:1.5em">
